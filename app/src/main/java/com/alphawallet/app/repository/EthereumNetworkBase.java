...
import static com.alphawallet.ethereum.EthereumNetworkBase.POODL_MAINNET_ID; //chaiwala
...
import static com.alphawallet.ethereum.EthereumNetworkBase.POODL_MAINNET_RPC_URL; // chaiwala
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    private static final List<Long> hasValue = new ArrayList<>(Arrays.asList(
            MAINNET_ID, POODL_MAINNET_ID, POLYGON_ID, ROOTSTOCK_MAINNET_ID, CLASSIC_ID, LINEA_ID, BASE_MAINNET_ID, MANTLE_MAINNET_ID, MINT_ID, BINANCE_MAIN_ID, HECO_ID, AVALANCHE_ID,
    ...
    {
        {
            ...
            put(POODL_MAINNET_ID, new NetworkInfo(C.XDAI_NETWORK_NAME, C.xDAI_SYMBOL,
                    POODL_MAINNET_RPC_URL,
                    "https://explorer.poodl.org/tx/", POODL_MAINNET_ID,
                    "https://rpc.poodl.org", "https://explorer.poodl.org?")); // chaiwala
    ...
    {
        {
            ...
            put(POODL_MAINNET_ID, R.color.xdai); //chaiwala
    ...
    private static int batchProcessingLimit(long chainId)
    {
        ...
        else if (chainId == POODL_MAINNET_ID)  // chaiwala
        {
