...
{ // implements EthereumNetworkRepositoryType
    public static final long POODL_MAINNET_ID = 15259;
    public static final long POODL_TESTNET_ID = 15257;
...
//     public static final long GNOSIS_ID = 100;
    ...
    public static final String POODL_MAINNET_RPC_URL = "https://rpc.poodl.org/";
    public static final String POODL_TESTNET_RPC_URL = "https://testnet-rpc.poodl.org/";
    ...
    {
        {
            ...
            put(POODL_MAINNET_ID, new NetworkInfo("POODL", "POODL", POODL_MAINNET_RPC_URL, "https://explorer.poodl.org/tx/",
                    POODL_MAINNET_ID, false));
            put(POODL_TESTNET_ID, new NetworkInfo("POODL TESTNET", "POODL", POODL_TESTNET_RPC_URL, "https://testnet.poodl.org/tx/",
                    POODL_TESTNET_ID, false));
